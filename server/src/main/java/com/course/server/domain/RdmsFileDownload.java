...
public class RdmsFileDownload {
    ...
    public String getDownloadorId() {
        return downloadorId;
    }

    public void setDownloadorId(String downloadorId) {
        this.downloadorId = downloadorId;
    }
    ...
    public String toString() {
        ...
        sb.append(", downloadorId=").append(downloadorId);
