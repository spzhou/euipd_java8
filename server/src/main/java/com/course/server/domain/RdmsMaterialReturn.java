...
public class RdmsMaterialReturn {
    private String id;
    ...
    public String toString() {
        ...
        sb.append(", checkOrNot=").append(checkOrNot);
        sb.append(", checkItemNo=").append(checkItemNo);
        sb.append(", targetWarehouseCode=").append(targetWarehouseCode);
