...
public class Live {
    ...
    public String getLiveStatusManual() {
        return liveStatusManual;
    }

    public void setLiveStatusManual(String liveStatusManual) {
        this.liveStatusManual = liveStatusManual;
    }
    ...
    public String toString() {
        ...
        sb.append(", liveStatusManual=").append(liveStatusManual);
        sb.append("]");
        return sb.toString();
    }
}