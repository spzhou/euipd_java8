...
create table `chapter` (
  ...
  primary key (`id`)
) engine=innodb default charset=utf8mb4 comment='篇章';

insert into `chapter` (id, course_id, name) values ('00000001', '00000000', '测试篇章01');
insert into `chapter` (id, course_id, name) values ('00000002', '00000000', '测试篇章02');
insert into `chapter` (id, course_id, name) values ('00000003', '00000000', '测试篇章03');
insert into `chapter` (id, course_id, name) values ('00000004', '00000000', '测试篇章04');
insert into `chapter` (id, course_id, name) values ('00000005', '00000000', '测试篇章05');
insert into `chapter` (id, course_id, name) values ('00000006', '00000000', '测试篇章06');
insert into `chapter` (id, course_id, name) values ('00000007', '00000000', '测试篇章07');
insert into `chapter` (id, course_id, name) values ('00000008', '00000000', '测试篇章08');
insert into `chapter` (id, course_id, name) values ('00000009', '00000000', '测试篇章09');
insert into `chapter` (id, course_id, name) values ('00000010', '00000000', '测试篇章10');
insert into `chapter` (id, course_id, name) values ('00000011', '00000000', '测试篇章11');
insert into `chapter` (id, course_id, name) values ('00000012', '00000000', '测试篇章12');
insert into `chapter` (id, course_id, name) values ('00000013', '00000000', '测试篇章13');
insert into `chapter` (id, course_id, name) values ('00000014', '00000000', '测试篇章14');
...
create table `section` (
  ...
  `chapter_id` char(8) comment '篇章|chapter.id',
...
insert into `user` (id, login_name, name, password) values ('10000000', 'test', '测试1', '202cb962ac59075b964b07152d234b70');
