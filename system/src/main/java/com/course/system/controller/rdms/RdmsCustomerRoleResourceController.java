...
@RestController
@RequestMapping("/rdms/customer-role-resource")
public class RdmsCustomerRoleResourceController {

    private static final Logger LOG = LoggerFactory.getLogger(RdmsCustomerRoleResourceController.class);
    public static final String BUSINESS_NAME = "客户角色资源关联";
