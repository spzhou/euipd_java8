...
public class VodUploadController {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(VodUploadController.class);
   ...
   /* @Value("${file.path}")
    ...
    @Resource
    private RdmsVodFileService fileService;

/*    @RequestMapping("/upload")
    public ResponseDto upload(@RequestBody RdmsVodFileDto fileDto) throws Exception {
        LOG.info("上传文件开始");
...
//        String path = dir + File.separator + key + "." + suffix + "." + fileDto.getShardIndex();
    ...
    private void merge(RdmsVodFileDto fileDto) throws Exception {
        LOG.info("合并分片开始");
    ...
    public ResponseDto check(@PathVariable String key) throws Exception {
        ...
        ResponseDto responseDto = new ResponseDto();
        RdmsVodFileDto fileDto = fileService.findByKey(key);
        if (fileDto != null) {
